...
public class ItemRegister {
    ...
    public static void Create(){
        flamethrower = new Item(GunRegister.flamethrower,"FlGun",new ArrayList<>(),"FlameGun");
        flamethrower.teg.add(TegItem.intimately);
        MedicineT1 = new Item(220,"Med1",new ArrayList<>(),"Medicine");
        MedicineT1.teg.add(TegItem.medicine);
        AK74 = new Item(GunRegister.AK74,"AK74",new ArrayList<>(),"AK74");
