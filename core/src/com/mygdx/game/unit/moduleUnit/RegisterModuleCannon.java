...
public class RegisterModuleCannon {
    ...
    public static void Create(){
        ...
        CannonFlame = new Cannon(55,35,34,17,1f,
                 10,6,0,0,1.5f,2
                ,2,4,85,15,20, FireRegister.FireFlame,"tower_enemy"
                ,func,ContentSound.flame_attack,0);
        CannonFlameAuxiliary = new Cannon(20,15,12,7,1f,
                10,4,0,0,1.5f,2
                ,2,4,85,15,20, FireRegister.FireFlame,"tower_enemy_auxiliary_1"
                ,func, ContentSound.flame_attack,0);
        CannonMortar = new Cannon(55,35,34,17,1f,
                320,15,22,25,1.5f,2
                ,400,4,400,15,20, FireRegister.FireMortar,"tower_enemy"
                ,func,ContentSound.cannon,120);
        CannonMachineGun = new Cannon(55,35,34,17,1.5f,
                70,22,22,25,0f,2
                ,5,12,650,15,20, FireRegister.FireBullet,"tower_enemy"
                ,func,ContentSound.machinegun,2);
        CannonMachineGunAuxiliary = new Cannon(20,15,12,7,1f,
                70,22,0,0,1.5f,2
                ,5,12,650,15,20, FireRegister.FireBullet,"tower_enemy_auxiliary_1"
                ,func, ContentSound.machinegun,2);
        CannonAcid = new Cannon(55,35,34,17,1f,
                20,6,0,0,0,2
                ,2,4,85,15,20, FireRegister.FireAcid,"tower_enemy"
